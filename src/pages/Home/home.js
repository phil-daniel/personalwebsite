...
export default function Home() {
    ...
    return <div class="Home-Content">
        ...
        <p className="main-text">I am a Third Year student at the <a href="https://www.bristol.ac.uk" target="_blank" rel="noopener noreferrer" className="link">University of Bristol</a>, studying Computer Science (BSc), graduating in 2025.
